...
Οι εργασίες που έπρεπε να παραδώσουμε ήταν σε μεγάλο βαθμό κατανοητές. Το πρώτο παραδοτέο ήταν αρκετά εύκολο απλά λόγω του ότι το πρόγραμμα το χρησιμοποιούσαμε για πρώτη φορά πήρε αρκετό χρόνο για την κατανόησή του παραδοτέου. Το δεύτερο ξέρωντας λίγο καλύτερα το πως λειτουργεί το proccesing ήταν το πιο ωραίο παραδοτέο διότι μπορούσαμε να διαμορφώσουμε με τον τρόπο που εμείς θέλαμε το κάθε υποερώτημα και ήταν και εύκολο σε πολύ μεγάλο βαθμό. Όσο αναφορά το τρίτο κατά την γνώμη ήταν το πιο απαιτητικό από όλα τα παραδοτέα.Βέβαι μεγάλο ρόλο έπαιξε το γεγονός ότι στο συγκεκριμένο πρόγραμμα τα περισσότερα από τα ζητούμενα ήταν έτοιμα μέσα από ήδη υπάρχοντα παραδείγματα και χρειαζόντουσαν μικρές αλλαγές. Γενικά το συγκεκριμένο μάθημα κατα την γνώμη μου με τον τρόπο που διδάσκεται βοηθάει πάρα πολύ στην κατανόηση του κώδικα ακόμα και σε άτομα τα οποία δεν έχουν κάποια σχετική επαφή και επίσης είναι πολύ ενδιαφέρον όσο αναφορά την αλληλεπίδραση χρήστη υπολογιστή. 
